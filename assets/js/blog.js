...
function renderBlogDetail(slug) {
  ...
  if($(".breadcrumb .current")) $(".breadcrumb .current").textContent = "BLOG DETAIL";
  ...
  box.innerHTML = `
    ...
    <nav class="bd-nav">
      <div class="bd-share">
        <span>Share:</span>
        <a href="https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}" class="bd-share-btn facebook" target="_blank" rel="noopener" title="Share on Facebook">
            <i class="fab fa-facebook-f"></i>
        </a>
        <a href="https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(shareTitle)}" class="bd-share-btn twitter" target="_blank" rel="noopener" title="Share on X">
      ...
      ${nextSlug ? `<a class="bd-next" href="#${nextSlug}">Next blogs →</a>` : `<span></span>`}
    </nav>
...
function showListView() {
  // THÊM MỚI: Cập nhật Breadcrumb
  if($(".breadcrumb .current")) $(".breadcrumb .current").textContent = "BLOG";
